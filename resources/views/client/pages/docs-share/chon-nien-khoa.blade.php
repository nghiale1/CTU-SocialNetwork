...
@section('title')
Quản lý tài liệu - Chọn năm học và học kỳ
@endsection
...
<div class="row" style="margin-bottom: 20px;">
    ...
    {{-- @foreach ($subject_student as $item)
        <div class="col-md-3">
            <div class="folder">
                <a href="#" class="btn btn-success" style="width: 100%;"><h5 style="font-size: 10px;"><i class="fa fa-folder" aria-hidden="true"></i> {{ $item->sub_name }}</h5></a>
            </div>
        </div>
    @endforeach --}}
